...
- (void)windowDidLoad
{
    ...
    if ([self.viewControllers count])
        self.selectedViewController = [self firstViewController]; //[self viewControllerForIdentifier:[[NSUserDefaults standardUserDefaults] stringForKey:kMASPreferencesSelectedViewKey]] ?: [self firstViewController];
